...
urlpatterns = [
    ...
    path('maps/Gipuzkoa/Santa/', core_view.santabarbara, name="SantaBarbara"),
    path('maps/Gipuzkoa/Txindoki/', core_view.txindoki, name="Txindoki"),
    path('maps/Gipuzkoa/Jaizkibel/', core_view.jaizkibel, name="Jaizkibel"),
    path('maps/Gipuzkoa/Jentilbaratza/', core_view.jentilbaratza, name="Jentilbaratza"),
    path('maps/Gipuzkoa/Amasola/', core_view.amasola, name="Jentilbaratza"),
