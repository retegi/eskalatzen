...
class ClimbingSpot(models.Model):
    ...
    regionId = models.CharField(max_length=200, null=True, blank=True, verbose_name='regioId')
    zoneId = models.CharField(max_length=200, null=True, blank=True, verbose_name='zoneId')
    locId = models.CharField(max_length=200, null=True, blank=True, verbose_name='locId')
    ...
    enable = models.BooleanField(null=True, blank=True, verbose_name='enable')
